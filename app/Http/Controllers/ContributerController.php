...
class ContributerController extends Controller
{
	...
	public function getLyricsByContributer(User $user)
	{
		...
		$data['heading'] = "Lyrics Contributed By " . $user->username;
