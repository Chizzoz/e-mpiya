...
class AlbumController extends Controller
{
	...
	public function getLyricsByAlbum($album_slug)
	{
		...
		$data['heading'] = "Lyrics from " . $album . " Album";
