...
@section('terms')
	<section id="terms">
		<div class="large-9 medium-8 small-12 columns">
			<div class="medium-12 columns terms my-callout">
				...
				You are free to delete your account with us at any point in time, if you wish to do so. Your profile, profile information and content contributed to the website will also be deleted within 30 days of deletion of your account. This can be done through the “Edit Profile” section or by request, if this option is not available to you. Any remaining traces of your account, after deletion, will be removed after the website cache has been cleared.</p>

				<p><strong>Termination of Agreements and Refunds Policy</strong><br>
				...
				Like most interactive web sites this Company’s website uses cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site to enable the functionality of this area and ease of use for those people visiting.</p>

				<p><strong>Links to this website</strong><br>
				You can create a link to any page on this website without our prior written consent. If you do create a link to a page of this website you do so at your own risk and the exclusions and limitations set out above will apply to your use of this website by linking to it.</p>

				<p><strong>Links from this website</strong><br>
				We do not monitor or review the content of other party’s websites which are linked to from this website. Opinions expressed or material appearing on such websites are not necessarily shared or endorsed by us and should not be regarded as the publisher of such opinions or material. Please be aware that we are not responsible for the privacy practices, or content, of these sites. We encourage our users to be aware when they leave our site & to read the privacy statements of these sites. You should evaluate the security and trustworthiness of any other site connected to this site or accessed through this site yourself, before disclosing any personal information to them. One Ziko will not accept any responsibility for any loss or damage in whatever manner, howsoever caused, resulting from your disclosure to third parties of personal information.</p>
				...
				<p>The website logo is the property of One Ziko. The brand names and specific services of this Company featured on this web site are all property of One Ziko.</p>

				<p><strong>Communication</strong><br>
				We have several e-mail addresses for different queries. These, & other contact information, can be found on our Contact Us link on our website or via Company literature or via the Company’s stated mobile telephone numbers.</p>
				...
				Failure of either Party to insist upon strict performance of any provision of this or any Agreement or the failure of either Party to exercise any right or remedy to which it, he or they are entitled hereunder shall not constitute a waiver thereof and shall not cause a diminution of the obligations under this or any Agreement. No waiver of any of the provisions of this or any Agreement shall be effective unless it is expressly stated to be such and agreed by both Parties.</p>
				...
				<p><strong>© One Ziko 2016 All Rights Reserved</strong></p>
			</div>
		</div>
		@yield('right_sidebar')
	</section>
